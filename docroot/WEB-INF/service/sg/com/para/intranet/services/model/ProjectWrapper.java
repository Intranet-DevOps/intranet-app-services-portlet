...
public class ProjectWrapper implements Project, ModelWrapper<Project> {
	...
	*/
	...
	@Override
	public int compareTo(sg.com.para.intranet.services.model.Project project) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<sg.com.para.intranet.services.model.Project> toCacheModel() {
		return _project.toCacheModel();
	}

	@Override
	public sg.com.para.intranet.services.model.Project toEscapedModel() {
		return new ProjectWrapper(_project.toEscapedModel());
	}

	@Override
	public sg.com.para.intranet.services.model.Project toUnescapedModel() {
